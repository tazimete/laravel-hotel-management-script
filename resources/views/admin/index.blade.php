      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="toolbar clearfix m-t-large m-b">
            ...
            <a href="" class="btn btn-primary btn-circle"><i class="fa fa-users fa-lg"></i><strong>Client</strong></a>
            <a href="" class="btn btn-info btn-circle"><i class="fa fa-qrcode fa-lg"></i><strong>Outlet</strong></a>
            <a href="" class="btn btn-success btn-circle"><i class="fa fa-truck fa-lg"></i><strong>Rider</strong></a>
			 <a href="" class="btn btn-warning btn-circle"><i class="fa fa-calendar-o"></i><strong>Duty Of Rider</strong></a>
            ...
            <a href="" class="btn btn-inverse btn-circle"><i class="fa fa-bar-chart-o"></i><strong>Order</strong></a>
            <a href="" class="btn btn-danger btn-circle"><i class="fa fa-user fa-lg"></i> <strong>User</strong></a>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">              
              <section class="panel">
                ...
                <div class="panel-body pull-in text-center">
                  <div class="inline">
                    <div class="easypiechart" data-percent="50" data-loop="false">
                      <span class="h2" style="margin-left:10px;margin-top:10px;display:inline-block">50</span>
            ...
            <div class="col-xs-6">
              <section class="panel">
                ...
                <div class="panel-body pull-in text-center">
                  <div class="inline">
                    <div class="easypiechart" data-percent="50" data-bar-color="#576879">
                      <span class="h2" style="margin-left:10px;margin-top:10px;display:inline-block">50</span>
