				...
				if(count($resturants) > 0){
				 ...
				 <tr>
					<td><input type="checkbox" name="clients[]" value=""></td>
							<td><?php echo $resturant->id; ?></td>
							<td><?php echo $resturant->name?></td>
							<td><?php echo $resturant->cuisine; ?></td>
							<td><?php echo $resturant->address; ?></td>
							<td><img src="{{URL::to('/')}}/<?php echo $resturant->picture; ?>" width="100" height="100" alt="" /></td>
							<td>
					...
					<tr>
						<td colspan="5" style="text-align: center;"><h5> No restaurant created yet</h5></td>
					</tr>
				<?php } ?>
