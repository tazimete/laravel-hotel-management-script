												...
												<div class="sub-panel-sub clearfix">
													<div class="sub-panel-inner sub-panel-inner-p0">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="muslim_prayer_mat" value="1" <?php if($muslim_prayer_mat == 1) { echo 'checked'; } ?> /> Yes, a prayer mat is available in the room.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="muslim_prayer_mat" value="2" <?php if($muslim_prayer_mat == 2) { echo 'checked'; } ?> /> A prayer mat can be requested.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="muslim_prayer_mat" value="3" <?php if($muslim_prayer_mat == 3) { echo 'checked'; } ?> /> A prayer mat can be requested.</label>
															</div>
														</div><!-- /.answer-box -->
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="qibla_direction" value="1" <?php if($qibla_direction == 1) { echo 'checked'; } ?> /> Yes, there is a Qibla Direction in our rooms.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="qibla_direction" value="2" <?php if($qibla_direction == 2) { echo 'checked'; } ?> /> No, there is no Qibla Direction in our rooms.</label>
															</div>
														</div><!-- /.answer-box -->
														<div class="question-box clearfix">  
															<div class="icon-box">
														...
														<div class="answer-box">                             
															<div class="radio">                     
																<label><input type="radio" name="quran_in_room" value="1" <?php if($quran_in_room == 1) { echo 'checked'; } ?> /> Yes, we provide the Quran in the room.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="quran_in_room" value="2" <?php if($quran_in_room == 2) { echo 'checked'; } ?> /> A guest can request a Quran during their stay.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="quran_in_room" value="3" <?php if($quran_in_room == 3) { echo 'checked'; } ?> /> No, we dao not provide the Quran.</label>
															</div>
														</div><!-- /.answer-box -->
													</div>
												</div>
											...
											<div class="sub-panel mb0">
												<div class="sub-panel-sub clearfix">
													<div class="sub-panel-inner sub-panel-inner-p0">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="praying_direction_from_hotel_staff" value="1" <?php if($praying_direction_from_hotel_staff == 1) { echo 'checked'; } ?> /> Yes, the praying direction can be obtained.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="praying_direction_from_hotel_staff" value="2" <?php if($praying_direction_from_hotel_staff == 2) { echo 'checked'; } ?> /> No, the praying direction cannot be obtained.</label>
															</div>
														</div><!-- /.answer-box -->
														<div class="question-box clearfix">
															<div class="icon-box">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="local_prayer_time_table" value="1" <?php if($local_prayer_time_table == 1) { echo 'checked'; } ?> /> Yes, you can obtain a list of the local prayer times from the front desk.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="local_prayer_time_table" value="2" <?php if($local_prayer_time_table == 2) { echo 'checked'; } ?> /> No, we do not provide the local prayer times.</label>
															</div>
														</div><!-- /.answer-box -->
														<div class="question-box clearfix">
															<div class="icon-box">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="halal_restaurant_list" value="1" <?php if($halal_restaurant_list == 1) { echo 'checked'; } ?> /> Yes, the hotel provides a list of halal restaurants.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="halal_restaurant_list" value="2" <?php if($halal_restaurant_list == 2) { echo 'checked'; } ?> /> No, the hotel does not provide a list of halal restaurants.</label>
															</div>
														</div><!-- /.answer-box -->
														<div class="question-box clearfix">
															<div class="icon-box">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="mosque_or_suraus_list" value="1" <?php if($mosque_or_suraus_list == 1) { echo 'checked'; } ?> /> Yes, the hotel provides a list of halal restaurants.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="mosque_or_suraus_list" value="2" <?php if($mosque_or_suraus_list == 2) { echo 'checked'; } ?> /> No, the hotel does not provide a list with Mosques/Suraus.</label>
															</div>
														</div><!-- /.answer-box -->
													</div>
												</div>
											...
											<div class="sub-panel mb0">
												<div class="sub-panel-sub clearfix">
													<div class="sub-panel-inner sub-panel-inner-p0">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="alcoholic_beverages" value="1" <?php if($alcoholic_beverages == 1) { echo 'checked'; } ?> /> Yes, we provide alcoholic beverages in the mini-bar.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="alcoholic_beverages" value="2" <?php if($alcoholic_beverages == 2) { echo 'checked'; } ?> /> No, we do not provide alcoholic beverages in the mini-bar..</label>
															</div>
														</div><!-- /.answer-box -->
														<div class="question-box clearfix">
															<div class="icon-box">
														...
														<div class="answer-box">
															<div class="radio">
																<label><input type="radio" name="halal_food" value="1" <?php if($halal_food == 1) { echo 'checked'; } ?> /> Yes, the hotel provides certified halal food.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="halal_food" value="2" <?php if($halal_food == 2) { echo 'checked'; } ?> />  Halal Food can be pre-ordered before arrival.</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="halal_food" value="3" <?php if($halal_food == 3) { echo 'checked'; } ?> /> No, the hotel does not provide certified halal food.</label>
															</div>
														</div><!-- /.answer-box -->
